    ...
    >
      ...
      <View style={[styles.featuredHeader, {
        ...
        <View style={[styles.scorePill, {
          ...
          <Text style={{ fontSize: 11, fontWeight: '800', color: colors.scoreText }}>
      ...
      <View style={[styles.featuredFooter, {
        ...
        >
          <Text style={{ fontSize: 11, fontWeight: '800', color: colors.accentText, textTransform: 'uppercase', letterSpacing: 0.5 }}>
            I'm going
          </Text>
        </TouchableOpacity>
      </View>
